...
3. 'CC_human_driver' : [3];
4. 'Reg157' : [4];
5. 'IDM_MOBIL' : Intelligent Driver Model + MOBIL [5, 6];
...
`python safety_check_runner.py one_case car_following model=IDM_MOBIL`
...
`python safety_check_runner.py post_processing cut_in`
    ...
    - a detailed analysis on IDM states is possible by selecting the IDM_MOBIL model

        `python safety_check_runner.py post_processing cut_in model=IDM_MOBIL`
...
[5] Treiber, Martin, Ansgar Hennecke, and Dirk Helbing. "Congested traffic states in empirical observations and 
    microscopic simulations." Physical review E 62.2 (2000): 1805.

[6] Kesting, Arne, Martin Treiber, and Dirk Helbing. "General lane-changing model MOBIL for car-following models." 
    Transportation Research Record 1999.1 (2007): 86-94.