...
def run_one_case(use_model, **kwargs):
    ...
    if use_model == 'FSM':
        ...
        check = md.IDM_MOBIL_check_safety
        react = md.IDM_MOBIL_react
        initial_distance = md.IDM_MOBIL_distance(imaginary_veh, ur / 3.6)
        print("Selected model: IDM_MOBIL")
    ...
    if use_model == 'IDM_MOBIL':
        ego_veh.use_idm = True
