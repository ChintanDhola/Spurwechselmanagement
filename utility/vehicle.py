...
class vehicle(object):
    ...
    def __init__(self):
        ...
        ''' IDM + MOBIL '''
        self.use_idm = False  # Flag to enable continuous control
        self.IDM_v0 = 130 / 3.6  # Desired speed (m/s)
        self.IDM_T = 1.5  # Desired time gap (s)
        self.IDM_s0 = 2.0  # Minimum jam distance (m)
        self.IDM_a = 1.4  # Max acceleration (m/s^2)
        self.IDM_b = 0.5  # Comfortable braking (m/s^2)
        self.IDM_delta = 4  # Acceleration exponent
        self.MOBIL_b_safe = 10.0  # Safe braking limit (m/s^2)