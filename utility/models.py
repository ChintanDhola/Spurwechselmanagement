...
from utility import idm_mobil

models_list = ['FSM', 'CC_human_driver', 'RSS', 'Reg157', 'IDM_MOBIL']
...
''' ================== IDM + MOBIL model ================== '''
def IDM_MOBIL_check_safety(ego_veh, cutting_in_veh, speed_log, speed_lat, freq, i):
    return idm_mobil.check_safety(ego_veh, cutting_in_veh, speed_log, speed_lat, freq, i)

def IDM_MOBIL_react(ego_veh, speed_log, freq):
    return idm_mobil.react(ego_veh, speed_log, freq)

def IDM_MOBIL_distance(ego_veh, ur):
    return idm_mobil.get_target_distance(ego_veh, ur)